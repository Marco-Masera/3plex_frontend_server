...
export DEBUG=0
export ALLOWED_HOSTS="192.168.186.10,www.3plex.unito.it,3plex.unito.it"
...
export DATABASE_PORT=30000
#Old config for sqlLite
#export DATABASE_ENGINE="sqlite3"
#export DATABASE_NAME="$PWD/triplex_frontend/db.sqlite3"